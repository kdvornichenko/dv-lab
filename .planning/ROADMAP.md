...
- [ ] **Phase 1: Repository Reset and Monorepo Scaffold** - Wipe legacy app surface and create the Turborepo structure.
- [ ] **Phase 2: Shared Packages and Data Model** - Adapt RBAC/DB/API package patterns and define teacher CRM schema.
- [ ] **Phase 3: Auth and Hono API Foundation** - Wire Supabase auth/session and typed Hono route foundation.
...
- [ ] **Phase 6: Payments and Ledger** - Build manual payment ledger and balance summaries.
- [ ] **Phase 7: Dashboard and Operational Polish** - Build dashboard, quick actions, responsive QA, and final verification.
...
Plans:
- [ ] 01-01: Pre-reset inventory and Supabase preservation list
- [ ] 01-02: Turborepo workspace scaffold
- [ ] 01-03: Baseline dev scripts, TypeScript configs, lint configs, and empty app shells
...
Plans:
- [ ] 02-01: Port package build patterns from ITS-DOC
- [ ] 02-02: Define CRM RBAC and API contract baseline
- [ ] 02-03: Define Drizzle schema, migrations, and seed data

### Phase 3: Auth and Hono API Foundation

**Goal**: The web app and API share an authenticated, typed request boundary.
**Depends on**: Phase 2
**Requirements**: AUTH-01, AUTH-02, AUTH-03, AUTH-04, API-01, API-02
**Success Criteria** (what must be TRUE):
  1. Teacher/admin can sign in with Supabase Auth.
...
Plans:
- [ ] 03-01: Supabase SSR clients and Next.js `proxy.ts`
- [ ] 03-02: Hono server, middleware, health, error format, and auth extraction
- [ ] 03-03: Typed client/API integration in web app shell
...
Plans:
- [ ] 06-01: Payment ledger schema, API, and service calculations
- [ ] 06-02: Payment entry and history UI
- [ ] 06-03: Balance/overdue summaries and ledger tests

### Phase 7: Dashboard and Operational Polish
...
Plans:
- [ ] 07-01: Dashboard data API and summary cards/tables
- [ ] 07-02: Quick actions and empty/loading/error states
- [ ] 07-03: Responsive QA, accessibility pass, and final v1 verification

## Progress

| Phase | Milestone | Plans Complete | Status | Completed |
|-------|-----------|----------------|--------|-----------|
| 1. Repository Reset and Monorepo Scaffold | v1.0 | 0/3 | Not started | - |
| 2. Shared Packages and Data Model | v1.0 | 0/3 | Not started | - |
| 3. Auth and Hono API Foundation | v1.0 | 0/3 | Not started | - |
| 4. Student Registry | v1.0 | 0/3 | Not started | - |
| 5. Lessons and Attendance | v1.0 | 0/3 | Not started | - |
| 6. Payments and Ledger | v1.0 | 0/3 | Not started | - |
| 7. Dashboard and Operational Polish | v1.0 | 0/3 | Not started | - |
