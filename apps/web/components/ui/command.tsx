	...
	return (
		<Dialog {...props}>
			<DialogContent className="overflow-hidden p-0">
				...
				<Command className="**:[[cmdk-group-heading]]:text-muted-foreground **:[[cmdk-group-heading]]:px-2 **:[[cmdk-group-heading]]:font-medium **:[[cmdk-group]]:px-2 **:[[cmdk-input]]:h-12 **:[[cmdk-item]]:px-2 **:[[cmdk-item]]:py-3 [&_[cmdk-group]:not([hidden])_~[cmdk-group]]:pt-0 [&_[cmdk-input-wrapper]_svg]:h-5 [&_[cmdk-input-wrapper]_svg]:w-5 [&_[cmdk-item]_svg]:h-5 [&_[cmdk-item]_svg]:w-5">
					{children}
				</Command>
			</DialogContent>
		</Dialog>
...
>(({ className, ...props }, ref) => (
	<ScrollArea className={cn('max-h-75', className)}>
		<CommandPrimitive.List ref={ref} className="overflow-visible" {...props} />
	</ScrollArea>
))
...
>((props, ref) => <CommandPrimitive.Empty ref={ref} className="px-2 py-6 text-center text-sm" {...props} />)
